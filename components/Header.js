...
function Header(){
    ...
    //user session connection inside...
    const {data: session} = useSession();
    //...this (renamed data = session) after de-structuring session
    // console.log(session);
                ...
                <div className="flex items-center justify-end space-x-4">
                    ...
                    {session ? (
                        ...
                        <>
                            ...
                            <InboxIcon className="navBtn"/>
                            <div className="absolute -top-2 -right-0 text-xs w-5 h-5
                                bg-red-500 text-white rounded-full flex items-center justify-center animate-pulse ">3</div>
                            </div>
                            ...
                            <img src={session.user.image} onClick={signOut } alt="profile pic" 
